...
interface CreateOscTcpTestArgs {
  logger: Logger;
  mode: 'single' | 'load';
...
export function createOscTcpTest ({
  logger,
  mode,
  remoteIpAddress,
  remotePort,
  ...
  batchInterval,
  messageRate,
}: CreateOscTcpTestArgs) {
  let tcpServer: net.Server | null = null;
  let client: osc.TCPSocketPort | null = null;
...
export type OscTcpTest = ReturnType<typeof createOscTcpTest>;
